 ...
 * Mainly used for incremental data
 * <p>
 * This implementation will attempt to commit 5 times before throwing {@link CommitFailedException}.
 *
 * This is not part of public API. It is meant to generate a staging snapshot
 * for incremental processing
 */
class IncrAppend extends SnapshotProducer<AppendFiles> implements AppendFiles {
  ...
  IncrAppend(TableOperations ops) {
    super(ops);
  ...
  @Override
  public IncrAppend appendFile(DataFile file) {
  ...
  @Override
  public IncrAppend appendManifest(ManifestFile manifest) {
  ...
  @Override
  public void commit() {
    throw new UnsupportedOperationException("Incremental snapshot is not committed to the table");
  }
}
